module AffiliateCredits
  ...
  def create_affiliate_credits(sender, recipient, event)
    ...
    sender_credit_amount = SpreeAffiliate::Config["sender_credit_on_#{event}_amount".to_sym]
    if sender_credit_amount and sender_credit_amount.to_f > 0
    ...
    recipient_credit_amount = SpreeAffiliate::Config["recipient_credit_on_#{event}_amount".to_sym]
    if recipient_credit_amount and recipient_credit_amount.to_f > 0
